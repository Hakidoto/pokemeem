  ...
  return (
    <div className="contentLogContent">
      <div className='overflow-auto logList border'>
        ...
        <li ref={lastLogItemRef} className={`list-group-item ${(conVida && conVidaAlly) && index === log.length - 1 ? 'bg-primary bg-transition' : index !== log.length - 1 ? 'bg-dark bg-transition' : 'bg-success bg-transition'} text-light m-1`} key={i++}>
