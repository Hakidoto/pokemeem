            ...
            <div className='contentHpBar' style={{ backgroundColor: getBackgroundColor(type) }}>
              ...
              <div className="flexNombre">
                ...
                <div className="row g-0 text-center border ">
                  ...
                  <div className={(HpAlly===0)?'my-1 text-start mx-1 text-danger nombreBarDerrotado' : 'text-center mx-4 nombreBar'} >{(HpAlly ===0)?`${name.charAt(0).toUpperCase() + name.slice(1)} derrotado` : HpAlly + "/" + hp}</div>
                  </div>
                </div>
              </div>
            </div>
