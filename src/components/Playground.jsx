...
const Playground = ({turno,pokemonEnemy, pokemon, HpEnemy, hpBarEnemy, processHealth, barColor, conVida, handleClickLog, enemyName,hpBarAlly, HpAlly,barColorAlly, processHealthAlly}) => {
  return (
    <div className="playground">
      ...
      <div className="charas">
        ...
        <AllyContainer pokemon={pokemon} hpBarAlly={hpBarAlly} HpAlly={HpAlly} barColorAlly={barColorAlly} />
      </div>

      <Footer turno={turno} conVida={conVida} enemyName={enemyName} handleClickLog={handleClickLog} pokemon={pokemon} processHealth={processHealth} processHealthAlly={processHealthAlly} pokemonEnemy={pokemonEnemy}/>
    </div>
  )
}
